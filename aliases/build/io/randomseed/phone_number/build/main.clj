(ns io.randomseed.phone-number.build.main

  (:require [io.randomseed.phone-number.build.pom-sync   :as pom-sync]
            [io.randomseed.phone-number.build.maven-meta :as    mmeta]
