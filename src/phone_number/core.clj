...
(defn time-zones
  ...
  ([^phone_number.core.Phoneable      phone-number
   ...
   (let [l (l/locale locale-specification)
         f (if (keyword? format-specification)
             (tz-format/all format-specification tz-format/default)
             format-specification)]
...
(defn time-zones-all-formats
  ...
  ([^phone_number.core.Phoneable      phone-number
   ...
   (let [l (l/locale locale-specification)
     ...
     (fmap #(time-zones p nil l %) tz-format/all))))
